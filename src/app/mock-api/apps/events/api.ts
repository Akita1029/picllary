...
import { labels as labelsData, events as eventsData } from 'app/mock-api/apps/events/data';
...
export class EventsMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('api/apps/events/labels')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onDelete('api/apps/events/labels')
            .reply(({request}) => {
