...
export class SearchComponent implements OnChanges, OnInit, OnDestroy
{
    ...
    {
        this.searchControl.valueChanges.subscribe(r=>{
        });
        // Appearance
            ...
            .subscribe((value) => {
                this._httpClient.post('api/common/search', {query: value})
                    .subscribe((resultSets: any) => {
                        ...
                        "id": "publicEvent",
                        "label": "Public Events",
                        "results":[{id:'1', name:'Event 1', avatar: 'https://material.angular.io/assets/img/examples/shiba1.jpg', eventId: '15'},
                                {id:'2', name:'Event 2', avatar: 'https://material.angular.io/assets/img/examples/shiba1.jpg', eventId: '20'}],
                    },
                    {
                        "id": "photographer",
                        "label": "Photographers",
                        "results":[{id:'1', name:'Salman', avatar: 'https://i.ytimg.com/vi/BNcxTNrtRdk/maxresdefault.jpg',  eventId: '20'}]}]
                        // Execute the event
